...
class Model:
    @staticmethod
    def format_data(delim:str, data:dict): # utilizing type annotations here just for better documentation, they don't affect the codes behavior at all
    ...
    def create(cls, **data:dict):
        ...
        # syntax is a bit different than a normal insert, because MySQL allows you to use the set syntax for insert as well as update
        query = f'''
